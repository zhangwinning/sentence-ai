...
export default function Form({generateCron, result, loading}: Props) {
  ...
  const onSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    generateCron(prompt, currentAuthor);
  };
    ...
    <form onSubmit={onSubmit}>
      <div className="space-y-6">
        <input
          name="prompt"
          type="text"
          placeholder="傍晚我出去吃饭，回来的时遇到了小明，我们交谈了好久"
        ...
        <Radio.Group defaultValue="primary" orientation="horizontal"
                     onChange={handleAuthor} className="pb-3 text-xl"
                     labelColor="primary"
        >
          ...
          <Radio value="古龙" color="secondary" labelColor="secondary" size={"xl"} style = {{backgroundColor: 'white'}}>
            古龙
          </Radio>
